...
#import "MTOldChallengesViewController.h"

@interface MTOldChallengesViewController ()

@property (assign, nonatomic) NSInteger pendingPageIndex;
@property (assign, nonatomic) NSInteger pageIndex;

@property (strong, nonatomic) MTOldChallengesContentViewController *viewControllerBefore;
@property (strong, nonatomic) MTOldChallengesContentViewController *viewControllerAfter;
@property (nonatomic) BOOL userChangedClass;

@end

// TODO: Remove Class
@implementation MTOldChallengesViewController
    ...
    [allCustomChallenges findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        ...
        if (!error) {
            ...
            if (!weakSelf.pageViewController) {
                ...
                MTOldChallengesContentViewController *startingViewController = [weakSelf viewControllerAtIndex:0];
...
- (MTOldChallengesContentViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    MTOldChallengesContentViewController *challengeContentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"ChallengesContentViewController"];
...
- (void)pageViewController:(UIPageViewController *)pageViewController willTransitionToViewControllers:(NSArray *)pendingViewControllers {
    self.pendingPageIndex = ((MTOldChallengesContentViewController *)[pendingViewControllers firstObject]).pageIndex;
}
