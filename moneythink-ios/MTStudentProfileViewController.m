...
#import "MTStudentProfileViewController.h"
...
@interface MTStudentProfileViewController ()
...
@implementation MTStudentProfileViewController
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [MTUtil GATrackScreen:@"Student Profile View: Student"];
}
